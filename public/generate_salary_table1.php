                    ...
                    <div class="box-header with-border">
                        <form method="POST" id="filter_form" name="filter_form">
                            <div class="form-group">
                                <input type="text" class="form-control" id="salmonth" name="salmonth" readonly>
                                <input type="text" class="form-control" id="salyear" name="salyear" readonly>

...
if (isset($_POST['btnAdd'])) {
    ...
    $sql_query = "INSERT INTO supplier (name,mobile,alt_mob,tax_no,dob,email,address,city,area,state,pincode,pay_days,pay_term,ship_add,status,created_at,updated_at)VALUES('$name', '$mobile', '$alt_mob','$tax_no','$dob','$email','$address','$city','$area','$state','$pincode','$pay_days','$pay_term','$ship_add','$status','$datetime','$datetime')";
    $db->sql($sql_query);
    $result = $db->getResult();
/*

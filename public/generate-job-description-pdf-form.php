...
$sql = "SELECT * FROM `job_description` WHERE id = '$id' AND location_id = '$location_id'";
// Execute query
$db->sql($sql);
// store result 
$res = $db->getResult();
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12" style="text-align-last: center;">
                            <div class="box">
                                ...
                                <div class="col-xs-12" style="text-align-last: left;">
                                    <h3><b>DISIGNATION : <?php echo $designation; ?></b></h3>
                                </div><br />
                                <div class="col-xs-12" style="text-align-last: left;">
                                    <h3><b>REPORTS TO : <?php echo $reports_to; ?></b></h3>
                                </div><br />
                                <div class="col-xs-12" style="text-align-last: left;">

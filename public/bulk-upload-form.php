        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                <form method="post" id="add_form" action="public/db-operation.php" enctype="multipart/form-data">
                    <input type="hidden" id="bulk_uploads" name="bulk_upload" required="" value="1" aria-required="true">
                    <div class="box-body">
...
<script>
    ...
    $('.box-footer > #sample').click(function(e) {
        ...
        if (type1 == 'products') {
            ...
            // window.location.href = 'download.php?location=library/variants.csv&filename=variants.csv&extension=csv';
        }
    ...
    $('.box-footer > #instructions').click(function(e) {
        ...
        if (type2 == 'products') {
            ...
            // window.location.href = 'download.php?location=library/variants.txt&filename=variants.txt&extension=txt';
        }

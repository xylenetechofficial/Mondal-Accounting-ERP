...
$sql = "SELECT * FROM `houskeeping_process` WHERE date = '$date' AND department = '$department' AND location_id = '$location_id'";
// Execute query
$db->sql($sql);
// store result 
$res = $db->getResult();
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-xs-12" style="text-align-last: center;">
                            <div class="box">
                                <div class="col-xs-12" style="text-align-last: center;">
                                    <h1><b>HOUSEKEEPING CHECKLIST</b></h1>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-12" style="text-align-last: center; background-color: lightgray;">
                            <div class="box">
                                <div class="col-xs-6" style="text-align-last: left;">
                                    <p><b>Contractor Name : <?php echo $contractor_name; ?></b></p>
                                </div>
                                <div class="col-xs-6" style="text-align-last: left;">
                                ...
                                <div class="box-body table-responsive" style="padding: 0px;">
                                    <table class="table table-hover">
                                        <tr>
                                            ...
                                            <th style="border: 1px solid black;">Subjects Of Review</th>
                                            <th style="border: 1px solid black;">Satisfactory Yes</th>
                                            <th style="border: 1px solid black;">Non Satisfactory No</th>
                                        ...
                                        ?>
                                            <tr>
                                                <td style="border: 1px solid black;"><?php echo $i;
                                                                                        $i++; ?></td>
                                                <td style="border: 1px solid black;"><?php echo $row['review_subject']; ?></td>
                                                <td style="border: 1px solid black;"><?php echo $row['satisfactory_yes']; ?></td>
                                                <td style="border: 1px solid black;"><?php echo $row['mom_satisfactory_no']; ?></td>
                        ...
                        <div class="col-xs-12" style="text-align-last: center; background-color: lightgray;">
                            <div class="box">
                                <div class="col-xs-12" style="text-align-last: left;">
                                    <p><b>Additional Remarks, id Any - </b></p>
                                    <p> <?php echo $additional_remark; ?></p>
                                </div>
                                <div class="col-xs-6" style="text-align-last: left;">
                                <img src="<?= $inspected_by; ?>" style="height: 60px;" alt="<?php echo $inspected_by; ?>" class="img-responsive">
                                </div>
                                <div class="col-xs-6" style="text-align-last: right;">
                                <img src="<?= $verify_by; ?>" style="height: 60px;" alt="<?php echo $verify_by; ?>" class="img-responsive">
                                </div>
                                <div class="col-xs-6" style="text-align-last: left;">
                                    <p><b>Inspected By Site Supervisor</b></p>
                                </div>
                                <div class="col-xs-6" style="text-align-last: right;">
                                    <p><b>Verification By Contractor Safty Officer</b></p>
                                </div>
                            </div>
                        </div>
                    </div>

...
$training_course = $_GET['training_course'];
...
$sql = "SELECT * FROM `strip_training_attand_sheet` WHERE date = '$date' AND training_course = '$training_course' AND location_id = '$location_id'";
// Execute query
$db->sql($sql);
// store result 
$res = $db->getResult();
...
$date = $row['date'];
$trainer_signature = $row['trainer_signature'];
$i = 1;
                        ...
                        <div class="col-xs-12" style="text-align-last: center;">
                            <div class="box">
                                <div class="col-xs-7" style="text-align-last: left;">
                                    <p><b>Training Course : <?php echo $training_course; ?></b></p>
                                </div>
                                <div class="col-xs-5" style="text-align-last: left;">
                                    <p><b>Trainer : <?php echo $trainer_name; ?></b></p>
                                </div>
                                <div class="col-xs-7" style="text-align-last: left;">
                                    <p><b>Description Of Training (or Attach Copy Of Training Course) : <?php echo $description; ?></b></p>
                                </div>
                                <div class="col-xs-5" style="text-align-last: left;">
                                    <p><b>date : <?php echo $date; ?></b></p>
                                </div>
                                <div class="col-xs-5" style="text-align-last: left;">
                                <p><b>Trainer Signature : </b></p><img src="<?= $trainer_signature; ?>" style="height: 50px;" alt="<?php echo $trainer_signature; ?>" class="img-responsive">
                                </div>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="border: 1px solid black;"><?php echo $row['emp_sign']; ?></td>
                                            </tr>
                                        <?php $row['id']++;
                                        } ?>
                                    </table>

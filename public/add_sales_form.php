                             ...
                             <div class="row">
                                 <div class="col-md-5">
                                     <div class="col-xs-7" style="text-align-last: left;">
                                         <div class="form-group pmd-textfield pmd-textfield-outline pmd-textfield-floating-label">
                                             <label for="outline-select">Customer</label>
                                             <select class="form-control" id="customer" name="customer" onchange="location = this.value;" required>
                                                 <option value="">--Select Customer--</option>
                                                 <option value="add_cust.php">Add Customer</option>
                                                 <?php
                                 ...
                                 <div class="col-md-4">
                                     <div class="col-xs-12" style="text-align-last: right;">
                                         <div class="form-group pmd-textfield pmd-textfield-outline pmd-textfield-floating-label">
                                             <p><label for="outline-select">Invoice No</label></p>
                                             <input type="text" name="invoice_no" class="form-control">
                                         </div>
                                     </div>
                                     <div class="col-xs-12" style="text-align-last: right;">
                                         <div class="form-group pmd-textfield pmd-textfield-outline pmd-textfield-floating-label">
                                             <p><label for="outline-select">Invoice Date</label></p>

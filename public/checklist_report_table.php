...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-header">
                        ...
                        <div class="box-header with-border">
                            <form id="form" role="form" method="get" enctype="multipart/form-data" action="create-checklist-report-pdf.php">
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table class="table no-margin" data-toggle="table" id="reports_list" data-url="api-firebase/get-bootstrap-table-data.php?table=checklist_report" data-page-list="[5, 10, 20, 50, 100, 200]" data-show-refresh="true" data-show-columns="true" data-side-pagination="server" data-pagination="true" data-search="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-query-params="queryParams">
                                <thead>
                                    <tr>
                                        <!--<th data-field="operate" data-sortable='true'>Action</th>-->
                                        <th data-field="name" data-sortable='true'>name.</th>
                                        <th data-field="date" data-sortable='true'>date</th>
                                        <th data-field="goggle" data-sortable='true'>goggle</th>
                                        <th data-field="gloves" data-sortable='true'>gloves</th>
                                        <th data-field="jacket" data-sortable='true'>jacket</th>
                                        <th data-field="shoes" data-sortable='true'>shoes</th>
                                        <th data-field="helmet" data-sortable='true'>helmet.</th>
                                        <th data-field="hand_sleevs" data-sortable='true'>hand_sleevs</th>
                                        <th data-field="leg_gaurd" data-sortable='true'>leg_gaurd</th>
                                        <th data-field="ear_plug" data-sortable='true'>ear_plug</th>
                                        <th data-field="remark" data-sortable='true'>remark</th>
                                        <th data-field="sign" data-sortable='true'>sign</th>
            ...
            <?php } else { ?>
                <div class="alert alert-danger">You have no permission to view Checklist Report.</div>
            <?php } ?>
        </div>
    </div>
</section>

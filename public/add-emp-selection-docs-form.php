...
if (isset($_POST['btnAdd'])) {
    ...
    if ($permissions['subcategories']['create'] == 1) {
        ...
        $emp_selection_docs = $db->escapeString($fn->xss_clean($_POST['emp_selection_docs']));
        ...
        if (empty($emp_selection_docs)) {
            $error['emp_selection_docs'] = " <span class='label label-danger'>Required!</span>";
        }

        if (!empty($emp_selection_docs)) {

            $sql_query = "INSERT INTO emp_selection_process_docs (emp_selection_docs, location_id, location, created_at, updated_at)
						VALUES('$emp_selection_docs', '$location_id', '$location', '$datetime', '$datetime')";
...
<section class="content-header">
    <h1>Add Employees Selection Documents Form<small><a href='add-emp-selection.php'> <i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to Employees Selection</a></small></h1>
        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Add Employees Selection Documents Form</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="form-group">
                            <div class="form-group">
                                <label for="emp_selection_docs">Add Employees Selection Form :</label> <i class="text-danger asterik">*</i><?php echo isset($error['emp_selection_docs']) ? $error['emp_selection_docs'] : ''; ?>
                                <textarea name="emp_selection_docs" id="emp_selection_docs" class="form-control" rows="8"></textarea>
                                <script type="text/javascript" src="css/js/ckeditor/ckeditor.js"></script>
                                <script type="text/javascript">
                                    CKEDITOR.replace('emp_selection_docs');
                                </script>
                            </div>

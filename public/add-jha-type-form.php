...
if (isset($_POST['btnAdd'])) {
    ...
    if ($permissions['categories']['create'] == 1) {
        ...
        if (!empty($name)) {
            ...
            $sql_query = "INSERT INTO `jha_type` (name,location_id,location)VALUES('$name', '$location_id', '$location')";
            $db->sql($sql_query);
            $result = $db->getResult();
            if (!empty($result)) {
                $result = 0;
...
<section class="content-header">
    <h1>Add JHA <small><a href='add-jha-type.php'> <i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to JHA</a></small></h1>
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">JHA Type</label><?php echo isset($error['name']) ? $error['name'] : ''; ?>

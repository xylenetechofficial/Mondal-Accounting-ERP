<section class="content-header">
    <h1>Staff Leave Apply List /<small><a href="home.php"><i class="fa fa-home"></i> Home</a></small></h1>
    </h1>
    <!--<ol class="breadcrumb">

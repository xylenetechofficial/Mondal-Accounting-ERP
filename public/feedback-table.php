            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table class="table table-hover" data-toggle="table" id="cateory_list" data-url="api-firebase/get-bootstrap-table-data.php?table=feedback" data-page-list="[5, 10, 20, 50, 100, 200]" data-show-refresh="true" data-show-columns="true" data-side-pagination="server" data-pagination="true" data-search="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-query-params="queryParams_1">
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="revision_no" data-sortable="true">Revision No</th>
                                    ...
                                    <th data-field="agree" data-sortable="true">Agree</th>
                                    <th data-field="neither_nor" data-sortable="true">Neither Agree Nor Disagree</th>
                                    <th data-field="disagree" data-sortable="true">Disagree</th>

...
$sql = "SELECT * FROM `mass_meeting` WHERE date = '$date' AND location_id = '$location_id'";
// Execute query
$db->sql($sql);
// store result 
$res = $db->getResult();
...
$present = $row['present'];
$safty_pause = $row['safty_pause'];
$pomb_discuss = $row['pomb_discuss'];
$doc_no = $row['doc_no'];
$rev = $row['rev'];
$i=1;
                        ...
                        <div class="col-xs-12" style="text-align-last: center;">
                            <div class="box">
                                <div class="col-xs-6" style="text-align-last: left;border: 1px solid black;">
                                    <p>Mass Meeting # : <?php echo $date; ?></p>
                                </div>
                                <div class="col-xs-6" style="text-align-last: center;border: 1px solid black;">
                                    <p>Date : <?php echo $date; ?></p>
                                </div>
                                <div class="col-xs-12" style="text-align-last: left;border: 1px solid black;">
                                    <p><b>Present: <?php echo $present; ?></b></p>
                                </div>
                                <div class="col-xs-12" style="text-align-last: left;border: 1px solid black;">
                                    <p><b>Safety Pause : <?php echo $safty_pause; ?></b></p>
                                </div>
                                <div class="col-xs-12" style="text-align-last: left;border: 1px solid black;">
                                    <p><b>Pomb Discussed : <?php echo $pomb_discuss; ?></b></p>
                                </div>
                                <!-- /.box -->
                            </div>
                            <!-- right col (We are only adding the ID to make the widgets sortable)-->
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="border: 1px solid black;"><?php echo $i;
                                                                                        $i++; ?></td>
                                                <td style="border: 1px solid black;"><?php echo $row['point']; ?></td>
                                                <td style="border: 1px solid black;"><?php echo $row['action']; ?></td>
                                                <td style="border: 1px solid black;"><?php echo  $row['target']; ?></td>
                                            </tr>
                                        <?php $row['id']++;
                                        } ?>
                                    </table>

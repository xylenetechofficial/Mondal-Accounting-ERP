...
$date = date("Y-m-d");
$sql_query = "SELECT * FROM emp_selection_process_docs WHERE id =" . $ID;
// Execute query
$db->sql($sql_query);
// store result 
$res = $db->getResult();
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<!-- form start -->
				<form id="form" role="form" method="get" enctype="multipart/form-data" action="generate_emp_selection_docs_pdf.php">
					<div class="box-body">

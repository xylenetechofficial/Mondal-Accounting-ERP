...
define('DOMAIN_URL', 'http://empire-engg.com/mandaladmin/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
define('ALLOW_MODIFICATION', 1);
define('JWT_SECRET_KEY', 'F35F156558B9709832EA59376F2099150F4D0BD130F640F0D945321B9DA8021B'); /* chnage to your secret key here set it to anything you like*/
...
class Database
{
    ...
    private $db_host = "xylenetech.online";  // Change as required
    // private $db_user = "u400800105_mandalAdmin";  // Change as required
    private $db_user = "xylene_admin";  // Change as required
    // private $db_pass = "";  // Change as required
    private $db_pass = "Xylenetech@2022";  // Change as required
    private $db_name = "xylene_mondal";    // Change as required
